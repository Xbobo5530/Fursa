...
public class Messaging {
    ...
    public static void sendCommonMessage() throws IOException {
        ...
        Log.d(TAG, "sendCommonMessage: " + "FCM request body for message using common notification object:");
        /*System.out.println("FCM request body for message using common notification object:");*/
        Log.d(TAG, "sendCommonMessage: " + notificationMessage);
    ...
    private static void prettyPrint(JsonObject jsonObject) {
        ...
        Log.d(TAG, "prettyPrint: " + gson.toJson(jsonObject) + "\n");
